<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="detaille.aspx.cs" Inherits="QuickFood.QuickFood.detaille"  EnableEventValidation="false"  %>
...
<!-- Mirrored from www.ansonika.com/quickfood/detail_page_2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Mar 2018 13:58:51 GMT -->
<head>
    <meta charset="utf-8">
...
<section class="parallax-window" data-parallax="scroll" data-image-src="img/sub_header_2.jpg" data-natural-width="1400" data-natural-height="470">
	...
	<div id="sub_content">
    	  ...
    	  <asp:Label ID="lbl_img" runat="server" Text="Label"></asp:Label>
                     <div class="rating">
                                   <cc1:Rating ID="Rating2" AutoPostBack="true" OnChanged="OnRatingChanged1" runat="server"
    StarCssClass="icon_star" WaitingStarCssClass="icon_star_alt" EmptyStarCssClass="icon_star_alt"
    FilledStarCssClass="icon_star" >
</cc1:Rating>
                     </div>
                    <h1><asp:Label ID="lbl_nom" runat="server" Text=""></asp:Label></h1>
                    
                    <div><i class="icon_pin"></i>   <asp:Label ID="lbl_adr" runat="server" Text="Label"></asp:Label></div>
    </div><!-- End sub_content -->
</div><!-- End subheader -->
</section><!-- End section -->
<!-- End SubHeader ============================================ -->
...
<!-- Mirrored from www.ansonika.com/quickfood/detail_page_2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Mar 2018 14:02:13 GMT -->
</html>
