<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListePlats.aspx.cs" Inherits="QuickFood.QuickFood.ListePlats" %>

<!DOCTYPE html>
<!--[if IE 9]><html class="ie ie9"> <![endif]-->
<html>

<!-- Mirrored from www.ansonika.com/quickfood/list_page.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Mar 2018 13:47:02 GMT -->
<head>
    <meta charset="utf-8">
...
<section class="parallax-window" id="short" data-parallax="scroll" data-image-src="img/sub_header_short.jpg" data-natural-width="1400" data-natural-height="350">
    <div id="subheader">
	<div id="sub_content">
    	<h1><asp:Label ID="lbl_nbp" runat="server" Text=""></asp:Label> résultats dans votre zone</h1>
...
<!-- End SubHeader ============================================ -->
    ...
    <div id="position">
        <div class="container">
             ...
             <a href="#0" class="search-overlay-menu-btn"><i class="icon-search-6"></i> Chercher</a>
        </div>
    </div><!-- Position -->
...
<div class="row">
                ...
                <asp:Label ID="lbl_pl" runat="server" Text=""></asp:Label>
                             
            

			</div>
            <hr>
					<h3 id="main_courses">Supplémentaire</h3>
            <div>
                <asp:Label ID="Lblsup" runat="server" Text=""></asp:Label>
            </div>
            <a href="#0" class="load_more_bt wow fadeIn" data-wow-delay="0.2s">charger plus..</a>  
		</div><!-- End col-md-9-->
...
<asp:DropDownList ID="drop_sexe"  class="form-control form-white" runat="server" placeholder="Sexe" Width="100%" >
	...
	<div class="search-overlay-menu">
		...
		<div>
			<input value="" name="q" type="search" placeholder="chercher..." />
...
<!-- Mirrored from www.ansonika.com/quickfood/list_page.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Mar 2018 13:47:06 GMT -->
</html>
